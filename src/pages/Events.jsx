...
const classes = {
  ...
  Card: "flex flex-col items-center justify-between gap-2 h-full bg-gray-300 xl:rounded-3xl md:rounded-2xl rounded-xl lg:p-6 md:p-5 p-6",
  CardHaderContainer: "flex flex-col items-center justify-center",
  CardHeader: "text-center xl:text-3xl lg:text-[26px] text-2xl font-HelveticaNeueBD text-shadow-3",
  CardDate: "text-center text-lg font-HelveticaNeueMD text-shadow-2",
  CardImage: "w-full h-auto object-cover xl:rounded-3xl md:rounded-2xl rounded-xl",
};
