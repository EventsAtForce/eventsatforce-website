...
const classes = {
    Container: 'flex flex-col items-center justify-center xl:gap-6 lg:gap-4 md:gap-3 gap-2 w-full h-full max-w-1440 xl:px-[100px] xl:pb-8 lg:px-[80px] lg:pb-6 sm:px-[60px] sm:pb-4 px-6 pb-4',
