...
const classes = {
  ...
  SoecitiesHeader: "font-HelveticaNeueBD xl:text-4xl xl:text-shadow-3 lg:text-3xl text-2xl text-shadow-2",
...
const Societies = () => {
  return (
    <div className={classes.SocietiesMain}>
      <h1 className={classes.SoecitiesHeader}>SOCIETIES / CLUBS</h1>
