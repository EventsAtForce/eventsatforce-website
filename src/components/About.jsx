...
const classes = {
  ...
  AboutImage: 'fit-cover xl:w-[600px] min-[1120px]:w-[550px] lg:w-[450px] min-[900px]:w-[400px] xl:rounded-3xl rounded-2xl transform transition-all duration-300 ease-out md:hover:-translate-y-3 md:hover:shadow-2xl',
  ...
  WhatWeDoImage: 'fit-cover hidden min-[900px]:block xl:w-[600px] min-[1120px]:w-[550px] lg:w-[450px] min-[900px]:w-[400px] xl:rounded-3xl rounded-2xl transform transition-all duration-300 ease-out md:hover:-translate-y-3 md:hover:shadow-2xl',
}
